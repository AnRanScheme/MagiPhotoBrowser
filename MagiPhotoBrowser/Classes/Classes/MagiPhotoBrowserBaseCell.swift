//
//  MagiPhotoBrowserBaseCell.swift
...
open class MagiPhotoBrowserBaseCell: UICollectionViewCell {
    /// ImageView
...
extension MagiPhotoBrowserBaseCell {
    /// 计算图片复位坐标
...
extension MagiPhotoBrowserBaseCell: UIScrollViewDelegate {
...
extension MagiPhotoBrowserBaseCell: UIGestureRecognizerDelegate {
